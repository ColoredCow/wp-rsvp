<div class="alert alert-success">
	<h4 class="alert-heading">Update Guest Details</h4>
	...
	<form id="guest_form">
		<div class="row">
			...
			<div class="form-group col-lg-4 col-md-4 col-sm-12">
				<label for="guest_mobile_number" class="form-control-label">
					<b>Update Guest Mobile Number</b>
				</label>
		...
		<div class="form-group col-lg-3 col-md-4 col-sm-12">
   			<button type="button" class="btn btn-outline-primary update-guest"  id="<?php echo $guest_id ?>">Update Guest Details</button>
		</div>
	</form>			
</div>
<hr>